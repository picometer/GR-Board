...
?>
<a href="view_memo.php" onclick="window.open(this.href, '_blank', 'width=600,height=700,menubar=no,scrollbars=yes'); return false" title="이 곳을 클릭하여 새로온 쪽지를 확인합니다."><img src="<?php echo $notifyPath; ?>/notify_box.gif" alt="새 쪽지 알림" /></a>