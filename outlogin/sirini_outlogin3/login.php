...
<a href="#" onclick="window.open('<?php echo $grboard; ?>/join.php?fromPage=outlogin','join','width=650,height=650,menubar=no,scrollbars=no');"><img src="<?php echo $grboard; ?>/outlogin/<?php echo $theme; ?>/join.gif" alt="멤버등록" /></a></div>
</form>
