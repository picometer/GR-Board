...
<div id="grLoginForm">
	...
	<a href="#" onclick="window.open('<?php echo $grboard; ?>/join.php?fromPage=outlogin','join','width=650,height=650,menubar=no,scrollbars=yes');"><img src="<?php echo $grboard; ?>/outlogin/<?php echo $theme; ?>/join.gif" onmouseover="v20.mouseOver(this);" onmouseout="v20.mouseOut(this);" alt="멤버등록" /></a>
	</div>
	</form>
</div>