...
if ($_POST['openid_action'] == "login"){ // Get identity from user and redirect browser to OpenID Server
	...
	if ($openid->GetOpenIDServer()){
		$openid->SetApprovedURL('http://' . $_SERVER["HTTP_HOST"] . $_SERVER["PHP_SELF"]);  	// Send Response from OpenID server to this script
...
<form action="<?php echo 'http://' . $_SERVER["HTTP_HOST"] . $_SERVER["PHP_SELF"]; ?>" method="post" onsubmit="this.login.disabled=true;">
